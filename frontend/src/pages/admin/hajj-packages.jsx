    ...
    <div className="min-h-screen bg-gray-100 px-4 py-6 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-xl font-bold text-gray-900 tracking-tight">Hajj Packages</h1>
            <p className="text-xs text-gray-500 mt-0.5">Manage and organize your Hajj offerings.</p>
          </div>
          ...
          <div className="divide-y divide-gray-100">
            {loading ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-xs text-gray-500 mt-1">Get started by creating a new Hajj package.</p>
              </div>
            )}
          </div>
